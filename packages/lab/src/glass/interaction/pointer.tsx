...
// A pointer in WORLD space on the interaction plane (z = the glass depth).
// One instance PER canvas (provided by <GlassScene>) — a shared singleton would let
// one panel's cursor leak into another's metaballs. Components read these refs in
// useFrame via usePointer() — never React state (the reel's hard rule).
