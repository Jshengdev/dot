...
// streak highlights along every curved silhouette (the reel's gloss signature). The
// retint for clean-blue: a COOL light room with a soft vertical gradient backdrop so
// a clear glass body has something to refract (a pure-white room would make it
// invisible). Cool streaks, one faint blue underlight. No fog, no vignette, no grain.
