...
// Each panel does: <Canvas><GlassScene><MyComponent/></GlassScene></Canvas>.
export function GlassScene({ children, pointerZ = 0.45 }: { children: React.ReactNode; pointerZ?: number }) {
