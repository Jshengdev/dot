...
// The metaball engine (the smooth-field merge behind blur-threshold-gooey).
// One isosurface per liquid body; ball positions are LOCAL [-1,1]^3. The field's
// smooth falloff buys the merge, the stretching neck and the pinch-off for free —
// you author balls, the field authors the liquid. Driven imperatively per frame.
